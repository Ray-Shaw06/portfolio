    ...
    <section id="contact" className="relative mx-auto max-w-7xl scroll-mt-24 px-6 py-24">
      <div className="animate-on-scroll mx-auto max-w-3xl text-center">
        <h2 className="font-geist text-4xl font-medium leading-tight tracking-[-0.035em] sm:text-5xl">
          ...
          <br />
          <span className="text-white/55">twenty minutes, I am easy to reach.</span>
        </h2>
        <p className="mx-auto mt-7 max-w-[58ch] text-[15px] leading-relaxed text-white/60">
        ...
        <p className="mt-8 font-mono text-[11.5px] text-white/50">{profile.screeningFacts}</p>
      </div>
    </section>
  );
}
