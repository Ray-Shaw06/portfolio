...
bug](/writing/evaluator-bug/), which is the narrower
...
| 4 | Quad / hamstring balance | Programming balance. Deliberately **not** an injury claim, see [rubric sources](https://github.com/Ray-Shaw06/spotterai/blob/main/docs/rubric-sources.md) |
...
Each one is also sourced in **[where the thresholds come from](https://github.com/Ray-Shaw06/spotterai/blob/main/docs/rubric-sources.md)**,
